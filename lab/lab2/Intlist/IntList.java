...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList returnEdit = returnList;
        IntList useA = A.rest;
        while (useA != null){
            returnEdit.rest = new IntList(useA.first, null);
            useA = useA.rest;
            returnEdit = returnEdit.rest;
        }
        IntList useB = B;
        while (useB != null){
            returnEdit.rest = new IntList(useB.first, null);
            useB = useB.rest;
            returnEdit = returnEdit.rest;
        }
